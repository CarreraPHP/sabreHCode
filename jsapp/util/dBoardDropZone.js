Ext.define('MyApp.util.dBoardDropZone', {
    extend: 'Ext.dd.DropTarget',

    constructor: function(portal, cfg) {
        this.portal = portal;
        Ext.dd.ScrollManager.register(portal.body);
        MyApp.util.dBoardDropZone.superclass.constructor.call(this, portal.body, cfg);
    ...
    unreg: function() {
        ...
        MyApp.util.dBoardDropZone.superclass.unreg.call(this);
    }
});