...
<html>
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="/library/ext-4.0/resources/css/ext-all.css"/>
        <link rel="stylesheet" type="text/css" href="resources/css/style.css"/>
        <script type="text/javascript" src="/library/ext-4.0/ext-all-debug-w-comments.js"></script>
